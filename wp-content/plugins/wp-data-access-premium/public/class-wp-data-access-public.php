...
class WP_Data_Access_Public {
	...
	public function enqueue_styles() {
		...
		if ( wpda_fremius()->is__premium_only() ) {
			...
			wp_register_style( 'wpdapro_jquery_datatables_buttons', 'https://cdn.datatables.net/buttons/1.6.1/css/buttons.dataTables.min.css' );
			wp_register_style( 'wpdapro_jquery_datatables_select', 'https://cdn.datatables.net/select/1.3.1/css/select.dataTables.min.css' );
			...
			// Add grid editor
			\WPDataAccess\Premium\WPDAPRO_Grid_Editor\WPDAPRO_Grid_Editor_Init::enqueue_styles();
		}
	}
	...
	public function enqueue_scripts() {
		...
		if ( wpda_fremius()->is__premium_only() ) {
			// Add jQuery DataTables buttons
			wp_register_script( 'wpdapro_jquery_datatables_buttons', 'https://cdn.datatables.net/buttons/1.6.2/js/dataTables.buttons.min.js', ['jquery','jquery_datatables','jquery_datatables_responsive'] );
			wp_register_script( 'wpdapro_jquery_datatables_flash', 'https://cdn.datatables.net/buttons/1.6.2/js/buttons.flash.min.js', ['jquery','jquery_datatables','jquery_datatables_responsive','wpdapro_jquery_datatables_buttons'] );
			wp_register_script( 'wpdapro_jquery_datatables_jszip', 'https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js', ['jquery','jquery_datatables','jquery_datatables_responsive','wpdapro_jquery_datatables_buttons'] );
			wp_register_script( 'wpdapro_jquery_datatables_pdfmake', 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/pdfmake.min.js', ['jquery','jquery_datatables','jquery_datatables_responsive','wpdapro_jquery_datatables_buttons'] );
			wp_register_script( 'wpdapro_jquery_datatables_vfs_fonts', 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js', ['jquery','jquery_datatables','jquery_datatables_responsive','wpdapro_jquery_datatables_buttons'] );
			wp_register_script( 'wpdapro_jquery_datatables_html5', 'https://cdn.datatables.net/buttons/1.6.2/js/buttons.html5.min.js', ['jquery','jquery_datatables','jquery_datatables_responsive','wpdapro_jquery_datatables_buttons'] );
			wp_register_script( 'wpdapro_jquery_datatables_print', 'https://cdn.datatables.net/buttons/1.6.2/js/buttons.print.min.js', ['jquery','jquery_datatables','jquery_datatables_responsive','wpdapro_jquery_datatables_buttons'] );
			wp_register_script( 'wpdapro_jquery_datatables_select', 'https://cdn.datatables.net/select/1.3.1/js/dataTables.select.min.js', ['jquery','jquery_datatables','jquery_datatables_responsive','wpdapro_jquery_datatables_buttons'] );
			wp_register_script( 'wpdapro_jquery_datatables_colvis', 'https://cdn.datatables.net/buttons/1.6.2/js/buttons.colVis.min.js', ['jquery','jquery_datatables','jquery_datatables_responsive','wpdapro_jquery_datatables_buttons'] );
			...
			// Add grid editor
			\WPDataAccess\Premium\WPDAPRO_Grid_Editor\WPDAPRO_Grid_Editor_Init::enqueue_scripts();
		}
	}
	...
	public function register_shortcodes() {
		...
		if ( wpda_fremius()->is__premium_only() ) {
			$datagrid = new \WPDataAccess\Premium\WPDAPRO_Grid_Editor\WPDAPRO_Grid_Editor_Init();
			add_shortcode( 'wpdagrid', [ $datagrid, 'shortcode_wpdagrid' ] );
		}
	}
	...
	public function wpdadiehard( $atts ) {
		...
		if ( isset( $atts['filter_field_name'] ) && isset( $atts['filter_field_value'] ) ) {
			$filter_field_name  = sanitize_text_field( wp_unslash( $atts['filter_field_name'] ) ); // input var okay.
