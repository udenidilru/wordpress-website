	...
	public function add_menu_items() {
		...
		if ( current_user_can( 'manage_options' ) ) {
			...
			if ( $this->page === self::PAGE_MAIN ) {
				$args = [ 'page_hook_suffix' => $this->wpda_data_explorer_menu ];
				if (
					( isset( $_REQUEST['page_action'] ) && 'wpda_import_csv' === $_REQUEST['page_action'] ) ||
					( isset( $_REQUEST['table_name'] ) && 'wp_wpda_csv_uploads' === $_REQUEST['table_name'] )
				) {
